...
def ResNet(stack_fn,
  ...
  attention_input2 = layers.Input(shape=attention_input_shape, name='attention_input2')
  ...
  x_att1 = layers.ZeroPadding2D(padding=((3, 3), (3, 3)), name='conv1_pad_att1')(attention_input)
  x_att1 = layers.Conv2D(64, 7, strides=2, use_bias=use_bias, name='conv1_conv_att1')(x_att1)

  x_att2 = layers.ZeroPadding2D(padding=((3, 3), (3, 3)), name='conv1_pad_att2')(attention_input2)
  x_att2 = layers.Conv2D(64, 7, strides=2, use_bias=use_bias, name='conv1_conv_att2')(x_att2)

  x = layers.Multiply()([x, x_att1])
  x = layers.Add()([x, x_att2])
  ...
  # Create model.
  model = training.Model([inputs, attention_input, attention_input2], x, name=model_name)
